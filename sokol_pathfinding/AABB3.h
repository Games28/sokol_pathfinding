...
struct AABB3 {
    ...
    cmn::vf3d min{ INFINITY,INFINITY,INFINITY }, max = -min;

    cmn::vf3d getMin() const
    {
        return min;
    }

    cmn::vf3d getMax() const
    {
        return max;
    }

    cmn::vf3d getCenter() const
    {
        return (min + max) / 2;
    }
    ...
    bool contains(const cmn::vf3d& p) const
    {
    ...
    void fitToEnclose(const cmn::vf3d& p) {
...
bool rayIntersectBox(const cmn::vf3d& orig, const cmn::vf3d& dir, const AABB3& box) {
...
void renderAABB(sg_pipeline& line_pip,const cmn::vf3d& a, const cmn::vf3d& b) {
